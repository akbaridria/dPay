      ...
      <div class="flex justify-between">
        ...
        <div class="flex items-center gap-2">
          <div class="dropdown">
            ...
            <ul tabindex="0" class="dropdown-content z-[1] menu p-2 shadow bg-base-100 rounded-box mt-[0.5rem] w-52">
          ...
          <button class="bg-cblack-100 px-[1.25rem] py-[1rem] rounded-xl hover:brightness-150 transition-all flex items-center gap-2 text-white">
